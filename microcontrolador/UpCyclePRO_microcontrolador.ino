...
===============================================================================
*//*
  CLASIFICADORA DE MATERIALES - VERSIÓN SIMPLE
  =============================================
  ...
  1. Enviar número (1, 2 o 3)
  2. Motor se enciende
  3. Sistema espera detección del PIR correspondiente
  4. Cuando PIR detecta → Motor se apaga → Servo empuja
  5. Vuelve a encender motor y espera siguiente objeto
...
void loop() {
  // Actualizar sistema (verificar sensores)
  classifier.update();
...
2. Enviar "1" 
3. Motor se enciende
4. Colocar objeto de vidrio en la banda
5. Cuando PIR1 detecta → Servo1 empuja el vidrio
6. Motor se vuelve a encender automáticamente
7. Sistema sigue esperando más objetos de vidrio
